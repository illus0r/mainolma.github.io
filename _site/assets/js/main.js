...
function updateCanvas(canvasName, divName) {
    ...
    var arr=["#FF0000","#7BCCC4","#2B8CBE","#084081"]
    //var arr2=["#084081", "#2B8CBE", "#7BCCC4", "#CCEBC5", "#F7FCF0"]
    var arr3=["#F7FCF0","#7BCCC4","#2B8CBE","#084081"]
...
function drawGraph() {
    ...
    d3.xml("assets/images/idea-scheme.svg").then(function(documentFragment,error) {
